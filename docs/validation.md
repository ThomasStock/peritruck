...
- Kiosk replica inspected in the browser at 1440×900 (physical kiosk with rails and the paperwork beside the device) and 375×812 (Mobile Driver Portal with inline top bar and the Paperwork sheet): language, method, visit type, reference (wrong and right value), country picker, phone confirmation, endscreen.
